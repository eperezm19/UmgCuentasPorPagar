...
$(document).ready(function () {
    ...
    $("#btnAddProveedor").click(function (e) {
        ...
        if (id > 0) {
            ...
            if (nombre != "" && direccion != "" && telefono != "" && correo != "" && nit != "" && saldo != "")
            {
                ...
                fetch(url + "/" + id, {
                    ...
                    body: JSON.stringify({
                        ...
                        "Correo": correo, "NIT": nit, "Saldo": saldo,
                    }),
                    cache: 'no-cache'
                })
...
async function RecuperarDatos(id) {
    ...
    var resp = await fetch(url + "?id=" + id)
        ...
        .then(function (data) {
            ...
            document.getElementById("txtSaldo").value = obj.saldo;
...
function AsignarProductos(id) {
    ...
    window.location.href = "asignarProductos.html?id=" + id;
}


function AsignarBancos(id) {

    window.location.href = "asignarBancos.html?id=" + id;
}
